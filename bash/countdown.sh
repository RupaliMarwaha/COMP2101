...
function secret_way {
  echo "Yuppieeeee, You have found a secret way to get out of the script"
}
...
# This function prints the program name and the value of first argument and redirects the error message to a file instead of command line
